...
HRESULT cottonSkinHelmet::init()
{
	...
	*/
	...
	_item.itemImage = IMAGEMANAGER->addImage("면피투구", "./image/equip/helmet/Hmt10.bmp", 34, 34, true, RGB(255, 0, 255));

	_item.limit[LEVEL_INDEX] = 6;		//레벨제한
	_item.limit[STAT_INDEX] = 0;		//스탯제한
	_item.limit[SKILL_INDEX] = 0;		//기술제한

	_item.effect[EFFECT_DEF] = 10;		//방어구 방어력
	_item.effect[EFFECT_MAXATT] = 0;	//

	_item.money = 2500;	//상점 500원판매
