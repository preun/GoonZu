...
HRESULT gravelSpear::init()
{
	...
	*/
	...
	_item.itemImage = IMAGEMANAGER->addImage("죽창", "./image/equip/spear/Spe01.bmp", 34, 34, true, RGB(255, 0, 255));

	_item.limit[LEVEL_INDEX] = 0;		//레벨제한
	_item.limit[STAT_INDEX] = 0;		//스탯제한
	_item.limit[SKILL_INDEX] = 0;		//기술제한

	_item.effect[EFFECT_MINATT] = 12;		//방어구 방어력
	_item.effect[EFFECT_MAXATT] = 16;	//

	_item.money = 1000;	//상점 500원판매
