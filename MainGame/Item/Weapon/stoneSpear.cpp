...
HRESULT stoneSpear::init()
{
	...
	*/
	...
	_item.itemImage = IMAGEMANAGER->addImage("석창", "./image/equip/spear/Spe05.bmp", 34, 34, true, RGB(255, 0, 255));

	_item.limit[LEVEL_INDEX] = 4;		//레벨제한
	_item.limit[STAT_INDEX] = 6;		//스탯제한
	_item.limit[SKILL_INDEX] =	3;		//기술제한

	_item.effect[EFFECT_MINATT] = 15;		//방어구 방어력
	_item.effect[EFFECT_MAXATT] = 20;	//

	_item.money = 3000;	//상점 500원판매
