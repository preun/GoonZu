...
HRESULT cottonSkinArmor::init()
{
	...
	*/
	...
	_item.itemImage = IMAGEMANAGER->addImage("면피갑옷", "./image/equip/armor/Arm10.bmp", 34, 34, true, RGB(255, 0, 255));

	_item.limit[LEVEL_INDEX] = 5;		//레벨제한
	_item.limit[STAT_INDEX] = 0;		//스탯제한
	_item.limit[SKILL_INDEX] = 0;		//기술제한

	_item.effect[EFFECT_DEF] = 15;		//방어구 방어력
